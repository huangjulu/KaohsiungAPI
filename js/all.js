...
function changeZone(zone){
    ...
    let zoneSelect = document.querySelector('#zoneSelect');
    let cardGroup = document.querySelector('.card_Group');
            ...
            card.innerHTML = `
                <div class="image" style="background-image: url( ${loc[i].Picture1})">
                    <div class="card_header">
                        <div class="card_title"> ${loc[i].Name} </div>
                        <div class="card_description"> ${loc[i].Zone} </div>
                    </div>
                </div>
                <div class = "card_content">
                    ...
                    <!--隱藏沒有資料的價格資訊-->
                    <div class="card_tag" style = "${loc[i].Ticketinfo ? ' ' : 'display:none'}">
